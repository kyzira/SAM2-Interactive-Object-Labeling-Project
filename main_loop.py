...
usecols = ["Videoname", "Videozeitpunkt (h:min:sec)", "Schadenskürzel", "Videopfad"]
...
while current_index <= total_length:
    ...
    # Segment frames
    app = sam2.ImageDisplayApp(frame_dir = current_frame_dir, video_path = input_path, frame_rate = frame_rate)
    app.run()
...
print(damage_table.iloc[0]['Videoname'])
